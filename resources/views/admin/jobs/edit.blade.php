        ...
        <div class="container py-5">
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <form action="{{ route('admin.jobupdate', $job->id) }}" method="post" id="userForm" name="userForm">
                        @csrf
                        @method('put')
                                    ...
                                    <div class="col-md-6  mb-4">
                                        ...
                                        <select name="category_id" id="category_id" class="form-control">
                                            ...
                                            @foreach ($categories as $category)
                                                <option
                                                    {{ old('category_id', $job->category->id) == $job->category->id ? 'selected' : '' }}
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <select name="job_type_id" id="job_type_id" class="form-select">
                                            ...
                                            @foreach ($jobTypes as $jobType)
                                                <option
                                                    {{ old('job_type_id', $job->jobs_type_id) == $job->jobs_type_id ? 'selected' : '' }}
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        <div class="form-check">
                                            <input class="form-check-input" {{ $job->is_featured == '1' ? 'checked' : '' }}
                                                type="checkbox" value="1" id="isFeatured" name="is_featured">
                                    ...
                                    <div class="col-md-6 mb-4 ">
                                        <div class="form-check-inline">
                                            <input class="form-check-input" {{ $job->status == '1' ? 'checked' : '' }}
                                        ...
                                        <div class="form-check-inline">
                                            <input class="form-check-input" {{ $job->status == '0' ? 'checked' : '' }}
                                                type="radio" value="0" id="status-inactive" name="status">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="experience" class="form-control" id="experience">
                                        <option value="" disabled
                                            {{ old('experience', $job->experience) ? '' : 'selected' }}>Select Experience
                                        </option>

                                        <option value="1"
                                            {{ old('experience', $job->experience) == '1' ? 'selected' : '' }}>1 Year
                                        </option>
                                        <option value="2"
                                            {{ old('experience', $job->experience) == '2' ? 'selected' : '' }}>2 Years
                                        </option>
                                        <option value="3"
                                            {{ old('experience', $job->experience) == '3' ? 'selected' : '' }}>3 Years
                                        </option>
                                        <option value="4"
                                            {{ old('experience', $job->experience) == '4' ? 'selected' : '' }}>4 Years
                                        </option>
                                        <option value="5"
                                            {{ old('experience', $job->experience) == '5' ? 'selected' : '' }}>5 Years
                                        </option>
                                        <option value="6"
                                            {{ old('experience', $job->experience) == '6' ? 'selected' : '' }}>6 Years
                                        </option>
                                        <option value="7"
                                            {{ old('experience', $job->experience) == '7' ? 'selected' : '' }}>7 Years
                                        </option>
                                        <option value="8"
                                            {{ old('experience', $job->experience) == '8' ? 'selected' : '' }}>8 Years
                                        </option>
                                        <option value="9"
                                            {{ old('experience', $job->experience) == '9' ? 'selected' : '' }}>9 Years
                                        </option>
                                        <option value="10"
                                            {{ old('experience', $job->experience) == '10' ? 'selected' : '' }}>10 Years
                                        </option>
                                        <option value="10_plus"
                                            {{ old('experience', $job->experience) == '10_plus' ? 'selected' : '' }}>10+
                                            Years</option>
                                    </select>
                                    <p></p>
                                </div>
